...
@section('title', 'WAR KKN — Rebutan Kelompok')
...
<section class="section">
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">WAR KKN</div>
        </div>
    </div>
    ...
    <div class="section-body">
        ...
        <div class="war-hero">
            <div class="war-hero-content">
                ...
                @else
                    <h1>WAR KKN</h1>
                    <p>Sistem Kelompok KKN secara realtime</p>
                @endif
        ...
        @if($warStatus === 'no_war')
            ...
            <div class="card">
                <div class="card-body state-block">
                    <h4 class="font-weight-bold mb-2">Tidak Ada WAR Aktif</h4>
                    <p class="text-muted mb-4">
                        Saat ini belum ada sesi WAR yang aktif. Pantau jadwal di bawah.
                    </p>
                </div>
            </div>
        ...
        @elseif($warStatus === 'not_registered')
            ...
            <div class="alert alert-warning d-flex align-items-center">
                ...
                <div>
                    <strong>Kamu belum terdaftar</strong> di gelombang war aktif ini.
                    Pastikan kamu sudah mendaftar KKN di gelombang yang sesuai.
                </div>
            </div>
        ...
        @elseif($warStatus === 'not_approved')
            ...
            <div class="alert alert-warning d-flex align-items-center">
                ...
                <div>
                    <strong>Pendaftaran belum disetujui.</strong>
                    Status pendaftaranmu saat ini: <strong>{{ $peserta?->status_pendaftaran }}</strong>.
        ...
        @elseif($warStatus === 'already_joined')
            ...
            <div class="alert alert-success d-flex align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('war.joined', $activeWar) }}" class="ml-2">Lihat detail &rarr;</a>
                </div>
            </div>
        ...
        @elseif($warStatus === 'ready')
            ...
            <div class="card">
                <div class="card-body state-block">
                    <h4 class="font-weight-bold mb-2">WAR Sedang Berlangsung!</h4>
                    <p class="text-muted mb-4">
                        Kamu eligible untuk ikut rebutan. Segera masuk arena sebelum kelompok penuh!
                    </p>
                    <a href="{{ route('war.arena', $activeWar) }}"
                       class="btn btn-war btn-lg">
...
(function () {
    ...
    function fetchStats() {
        fetch("{{ route('admin.war.monitor.stats', $activeWar) }}")
            ...
            .then(d => {
                ...
                // Redirect jika war sudah closed
    ...
    fetchStats();
    setInterval(fetchStats, 10000); // refresh tiap 10 detik
})();
</script>
@endif
@endpush
