...
@section('title', 'Tambah Kelompok KKN')
    ...
    <div class="section-body">
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('kelompok-kkn.store') }}"
                      method="POST">
                                ...
                                <select
                                    ...
                                    @forelse($desaGelombang as $item)
                                        ...
                                        <option value="{{ $item->id }}"
                                            {{ old('desa_gelombang_id') == $item->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    @foreach($dpl as $item)
                                        ...
                                        <option value="{{ $item->id }}"
                                            {{ old('dosen_pembimbing_lapangan_id') == $item->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    <option value="dibuka"
                                        {{ old('status') == 'dibuka' ? 'selected' : '' }}>
                                        Dibuka
                                    </option>

                                    <option value="ditutup"
                                        {{ old('status') == 'ditutup' ? 'selected' : '' }}>
                                        Ditutup
                                    </option>
                    ...
                    <div class="alert alert-light border mt-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span>
                                Kode kelompok akan dibuat otomatis oleh sistem setelah data berhasil disimpan.
                            </span>
